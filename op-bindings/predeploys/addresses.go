...
const (
	...
	PushOracle                    = "0x1100000000000000000000000000000000000001"
)
...
var (
	...
	PushOracleAddr                    = common.HexToAddress(PushOracle)
...
func init() {
	...
	Predeploys["PushOracle"] = &Predeploy{Address: PushOracleAddr}
